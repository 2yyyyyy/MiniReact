...
export function createWorkInProgress(
	...
	const curDependencies = current.dependencies;
	wip.dependencies =
		curDependencies === null
			? null
			: {
					firstContext: curDependencies.firstContext,
					lanes: curDependencies.lanes
			  };
	return wip;
}
